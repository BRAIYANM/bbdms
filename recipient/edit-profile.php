...
$sql="update tblreciepient set FullName=:FullName, MobileNumber=:MobileNumber, Gender=:Gender, Age=:Age, Address=:Address, Message=:Message where EmailId=:EmailId";
...
<head>
	...
	<title>THBMS | Recipient Edit Profile</title>

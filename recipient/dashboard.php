...
<head>
	...
	<title>THBMS | Recipient Dashboard</title>
...
$sql ="SELECT id from tbldonateblood where EmailId=:useremail";
$query = $dbh -> prepare($sql);
$query -> bindParam(':useremail',$useremail, PDO::PARAM_STR);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
...
?>
													...
													<div class="stat-panel-title text-uppercase">Donated Blood </div>
												</div>
											</div>
...
<?php 
$useremail=$_SESSION['login'];
$sql1 ="SELECT id from tblrequetblood where EmailId=:useremail";
...
?>
													...
													<div class="stat-panel-title text-uppercase">Blood Requested </div>
												</div>
											</div>
											<a href="#" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>

...
$status=1;
$sql="INSERT INTO  tblblooddonars(FullName,MobileNumber,EmailId,Username,Password,Age,Gender,BloodGroup,Address,Message,status) VALUES(:fullname,:mobile,:email,:username,:password,:age,:gender,:blodgroup,:address,:message,:status)";
...
<div class="col-md-8 col-md-offset-2">
 <a class="btn btn-primary btn-block" href="donor/" >Donor Login to record blood donated</a>
</div>
</div>

...
$msg="Request Re-Approved Successfully";
}
...
<head>
	...
	<title>THBMS | Admin Requests</title>
...
<?php $sql = "SELECT * from  tblrequetblood ";
$query = $dbh -> prepare($sql);
$query->execute();
...
{?>
<a href="view-requests.php?approve=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to approve this request')"> Approve</a> |
...
<a href="view-requests.php?reaprove=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to re-approve this request')"> Re-Approve</a>
<?php } else {?>
